...
public class SecurityCookieConfig {
	 ...
	 * @return 对象自身 
	 */
	public SecurityCookieConfig setDomain(String domain) {
		this.domain = domain;
		return this;
	}
	 ...
	 * @return 对象自身 
	 */
	public SecurityCookieConfig setPath(String path) {
		this.path = path;
		return this;
	}
	 ...
	 * @return 对象自身 
	 */
	public SecurityCookieConfig setSecure(Boolean secure) {
		this.secure = secure;
		return this;
	}
	 ...
	 * @return 对象自身 
	 */
	public SecurityCookieConfig setHttpOnly(Boolean httpOnly) {
	 ...
	 * @return 对象自身 
	 */
	public SecurityCookieConfig setSameSite(String sameSite) {
	...
	public String toString() {
		return "SecurityCookieConfig [domain=" + domain + ", path=" + path + ", secure=" + secure + ", httpOnly=" + httpOnly
				+ ", sameSite=" + sameSite + "]";
	}
